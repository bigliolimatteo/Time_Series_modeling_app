...
fourier_element <- function(length=100, period = 1, armonic= 1) {
  x = (2*pi*armonic)/period*c(1:length)
  return(cbind(sin(x), cos(x)))
}
# random
# while(TRUE){
#   sample =  sample(1:10000,1)/1000 * fourier_element(50, 24, 2)[,1] + 
#             sample(1:10000,1)/1000 * fourier_element(50, 24, 2)[,2] + 
#             sample(1:10000,1)/1000 * fourier_element(50, 24, 4)[,1] + 
#             sample(1:10000,1)/1000 * fourier_element(50, 24, 4)[,2] + 
#             sample(1:10000,1)/1000 * fourier_element(50, 24, 6)[,1] + 
#             sample(1:10000,1)/1000 * fourier_element(50, 24, 6)[,2] + 
#             sample(1:10000,1)/1000 * fourier_element(50, 24, 8)[,1] + 
#             sample(1:10000,1)/1000 * fourier_element(50, 24, 8)[,2] 
#   lines(sample, type='l', col = sample(1:100,1))
#   Sys.sleep(.2)
# }
# colors[sample(1:10,1)]
# plot(fourier_element(50, 24, 2)[,2], type='l', col = 30)
# seecol("pref_all")
# fourier_element(100)
